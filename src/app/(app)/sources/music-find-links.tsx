 ...
 *
 * 2026-09-24에 **사용자가 일곱 곳을 모두 눌러보고** 검색어를 주소로 넘길 수
 * 있다는 것을 확인했다. 그래서 지금은 누르면 바로 그 곡으로 검색된다.
 * 붙여넣기가 필요 없다.
 *
 * 복사해 두는 길(`copy`)은 남겨둔다. 새로 더하는 곳은 확인 전까지 그쪽으로
 * 출발해야 하기 때문이다. (search-links.ts) 지금 그 길로 가는 곳은 없다.
 */
    ...
    if (copyTerm) {
      try {
        ...
        /*
          ...
          이때는 **사용자가 손으로 적어야 한다.** 평범한 글로 보여주면
          복사됐다는 안내와 구분되지 않아 그냥 붙여넣기를 시도하게 된다.
          할 일이 달라졌으므로 눈에 띄어야 한다.
        */
        setFailed(true);
      ...
      {canSearch ? (
        <>
          <p className="text-xs leading-5 text-zinc-500">
            아래를 누르면 그 서비스에서 이 곡으로 바로 검색됩니다. 찾은 곡의
            주소를 복사해 아래 `링크 담기` 칸에 붙여넣으세요.
          </p>
